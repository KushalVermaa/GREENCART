...
const ProductCard = ({product}) => {
    ...
    ${product._id}` ); scrollTo(0,0)}}
        className="border border-gray-500/20 rounded-md md:px-4
         px-3 py-2 bg-white min-w-56 max-w-56 w-full">
                ...
                <div className="flex items-center gap-0.5">
                    {Array(5).fill('').map((_, i) => (
                           ...
                           <img key={i} className='md:w-3.5 w-3'
                            src={i<4 ? assets.star_icon : assets.star_dull_icon} alt="star" />
